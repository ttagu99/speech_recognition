...
for i in range(9):
    x_1d = Conv1D(8*(2 ** i), (3),padding = 'same')(x_1d)
...
x_merge = Dense(len(POSSIBLE_LABELS), activation = 'softmax',name='cls')(x_merge)
model = Model(inputs = [x_in, x_in_1d], outputs = x_merge)


#model = Model(inputs = x_in, outputs = x)
weight_name = 'combi_1dvgg_2dres.hdf5'
#weight_name = '1dcnn_last32_noiseadd_ts_mul_balance_inputnormal_submean_abs_whitenadd_sgd.hdf5'
